...
For example, to change the `at-rule-no-unknown` rule to use its `ignoreAtRules` option, change the `indentation` to tabs, turn off the `number-leading-zero` rule,and add the `unit-allowlist` rule:
...
-   Specify acceptable selector types, units, properties, functions and words in comments using:
    -   [`at-rule-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/at-rule-denylist/README.md)
    -   [`at-rule-allowlist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/at-rule-allowlist/README.md)
    ...
    -   [`comment-word-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/comment-word-denylist/README.md)
    -   [`declaration-no-important`](https://github.com/stylelint/stylelint/blob/master/lib/rules/declaration-no-important/README.md)
    -   [`declaration-property-unit-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/declaration-property-unit-denylist/README.md)
    -   [`declaration-property-unit-allowlist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/declaration-property-unit-allowlist/README.md)
    -   [`declaration-property-value-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/declaration-property-value-denylist/README.md)
    -   [`declaration-property-value-allowlist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/declaration-property-value-allowlist/README.md)
    -   [`function-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/function-denylist/README.md)
    -   [`function-url-scheme-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/function-url-scheme-denylist/README.md)
    -   [`function-url-scheme-allowlist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/function-url-scheme-allowlist/README.md)
    -   [`function-allowlist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/function-allowlist/README.md)
    -   [`media-feature-name-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/media-feature-name-denylist/README.md)
    -   [`media-feature-name-allowlist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/media-feature-name-allowlist/README.md)
    -   [`property-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/property-denylist/README.md)
    -   [`property-allowlist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/property-allowlist/README.md)
    -   [`selector-attribute-operator-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/selector-attribute-operator-denylist/README.md)
    -   [`selector-attribute-operator-allowlist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/selector-attribute-operator-allowlist/README.md)
    -   [`selector-combinator-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/selector-combinator-denylist/README.md)
    -   [`selector-combinator-allowlist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/selector-combinator-allowlist/README.md)
    ...
    -   [`selector-pseudo-class-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/selector-pseudo-class-denylist/README.md)
    -   [`selector-pseudo-class-allowlist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/selector-pseudo-class-allowlist/README.md)
    -   [`selector-pseudo-element-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/selector-pseudo-element-denylist/README.md)
    -   [`selector-pseudo-element-allowlist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/selector-pseudo-element-allowlist/README.md)
    -   [`unit-denylist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/unit-denylist/README.md)
    -   [`unit-allowlist`](https://github.com/stylelint/stylelint/blob/master/lib/rules/unit-allowlist/README.md)
