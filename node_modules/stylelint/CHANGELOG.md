...
- Deprecated: `*-denylist`, `*-requirelist` and `*-allowlist` rules in favour of the new `*-disallowed-list`, `*-required-list` and `*-allowed-list` ones ([#4845](https://github.com/stylelint/stylelint/pull/4845)):
  - `at-rule-denylist`. Use `at-rule-disallowed-list` instead.
  - `at-rule-property-requirelist`. Use `at-rule-property-required-list` instead.
  - `at-rule-allowlist`. Use `at-rule-allowed-list` instead.
  - `comment-word-denylist`. Use `comment-word-disallowed-list` instead.
  - `declaration-property-unit-denylist`. Use `declaration-property-unit-disallowed-list` instead.
  - `declaration-property-unit-allowlist`. Use `declaration-property-unit-allowed-list` instead.
  - `declaration-property-value-denylist`. Use `declaration-property-value-disallowed-list` instead.
  - `declaration-property-value-allowlist`. Use `declaration-property-value-allowed-list` instead.
  - `function-denylist`. Use `function-disallowed-list` instead.
  - `function-url-scheme-denylist`. Use `function-url-scheme-disallowed-list` instead.
  - `function-url-scheme-allowlist`. Use `function-url-scheme-allowed-list` instead.
  - `function-allowlist`. Use `function-allowed-list` instead.
  - `media-feature-name-denylist`. Use `media-feature-name-disallowed-list` instead.
  - `media-feature-name-value-allowlist`. Use `media-feature-name-value-allowed-list` instead.
  - `media-feature-name-allowlist`. Use `media-feature-name-allowed-list` instead.
  - `property-denylist`. Use `property-disallowed-list` instead.
  - `property-allowlist`. Use `property-allowed-list` instead.
  - `selector-attribute-operator-denylist`. Use `selector-attribute-operator-disallowed-list` instead.
  - `selector-attribute-operator-allowlist`. Use `selector-attribute-operator-allowed-list` instead.
  - `selector-combinator-denylist`. Use `selector-combinator-disallowed-list` instead.
  - `selector-combinator-allowlist`. Use `selector-combinator-allowed-list` instead.
  - `selector-pseudo-class-denylist`. Use `selector-pseudo-class-disallowed-list` instead.
  - `selector-pseudo-class-allowlist`. Use `selector-pseudo-class-allowed-list` instead.
  - `selector-pseudo-element-denylist`. Use `selector-pseudo-element-disallowed-list` instead.
  - `selector-pseudo-element-allowlist`. Use `selector-pseudo-element-allowed-list` instead.
  - `unit-denylist`. Use `unit-disallowed-list` instead.
  - `unit-allowlist`. Use `unit-allowed-list` instead.
...
- Added: `media-feature-name-value-allowlist` rule ([#3320](https://github.com/stylelint/stylelint/pull/3320)).
...
- Added: `ignoreMediaFeatureNames` to `unit-denylist` ([#3027](https://github.com/stylelint/stylelint/pull/3027)).
...
- Changed: `*-denylist` and `*-allowlist` (and `ignore* []` secondary options) are now case sensitive. Use regular expressions with the `i` flag for case insensitivity ([#2709](https://github.com/stylelint/stylelint/issues/2709)).
...
- Deprecated: 6 rules, each has been replaced by a more configurable alternative ([#2679](https://github.com/stylelint/stylelint/pull/2679)).
  - `function-url-data-uris` rule. Use either `function-url-scheme-denylist` or `function-url-scheme-allowlist`.
...
- Added: `function-url-scheme-denylist` rule ([#2626](https://github.com/stylelint/stylelint/pull/2626)).
- Added: `function-url-scheme-allowlist` regex support ([#2662](https://github.com/stylelint/stylelint/pull/2662)).
...
- Fixed: `function-url-scheme-allowlist` was working incorrectly if more than one URL scheme were specified ([#2447](https://github.com/stylelint/stylelint/pull/2447)).
...
- Added: `media-feature-name-denylist` rule.
- Added: `media-feature-name-allowlist` rule.
...
- Added: `function-url-scheme-allowlist` rule.
...
- Added: `ignoreProperties` option to `unit-denylist` and `unit-allowlist`
...
- Fixed: `no-unknown-animations` and `unit-denylist` now handle numbers without leading zeros.
...
- Added: `selector-pseudo-class-denylist` rule.
- Added: `selector-pseudo-class-allowlist` rule.
...
- Added: `ignoreTypes` option to `selector-no-type` to allowlist allowed types for selectors.
...
- Fixed: `at-rule-denylist`, `at-rule-allowlist`, `comment-word-denylist`, `selector-attribute-operator-denylist`, `selector-attribute-operator-allowlist` now accept array as first option.
...
- Removed: `property-unit-denylist` rule. Use the `declaration-property-unit-denylist` rule instead.
- Removed: `property-unit-allowlist` rule. Use the `declaration-property-unit-allowlist` rule instead.
- Removed: `property-value-denylist` rule. Use the `declaration-property-value-denylist` rule instead.
- Removed: `property-value-allowlist` rule. Use the `declaration-property-value-allowlist` rule instead.
...
- Changed: `comment-word-denylist` no longer ignores words within copyright comments.
- Changed: `comment-word-denylist` will now identify strings within comments, rather than just at the beginning of, when the string option is used.
...
- Deprecated: `property-*-denylist` and `property-*-allowlist`. Use `declaration-property-*-denylist` and `declaration-property-*-allowlist` instead.
...
- Added: `at-rule-denylist` rule.
- Added: `at-rule-name-newline-after` rule.
- Added: `at-rule-allowlist` rule.
...
- Added: `function-denylist` now accepts regular expressions.
- Added: `function-allowlist` now accepts regular expressions.
...
- Added: `selector-attribute-operator-denylist` rule.
- Added: `selector-attribute-operator-allowlist` rule.
...
- Fixed: `unit-denylist`, `unit-case`, `unit-no-unknown`, `unit-allowlist` now better accounts interpolation.
...
- Added: `comment-word-denylist` rule.
...
- Fixed: `property-value-denylist` and `-allowlist` no longer error on properties without a corresponding list entry.
...
- Fixed: `unit-denylist` and `unit-allowlist` now ignores `url` functions.
...
- Fixed: removed `console.log()`s in `property-unit-allowlist`.
...
- Fixed: include `testUtils` in npm package allowlist.
...
- Added: `property-value-denylist` rule.
- Added: `property-value-allowlist` rule.
- Added: `time-no-imperceptible` rule.
- Added: `ignore: "descendant"` and `ignore: "compounded"` options for `selector-no-type`.
- Added: support for regular expression property identification in `property-denylist`, `property-unit-denylist`, `property-unit-allowlist`, `property-value-denylist`, and `property-allowlist`.
- Added: better handling of vendor prefixes in `property-unit-denylist` and `property-unit-allowlist`, e.g. if you enter `animation` it now also checks `-webkit-animation`.
...
- Fixed: `property-allowlist`, `rule-no-duplicate-properties`, and `rule-properties-order` ignore variables (`$sass`, `@less`, and `--custom-property`).
...
- Added: `function-denylist` rule.
- Added: `function-allowlist` rule.
- Added: `unit-denylist` rule.
- Added: `unit-allowlist` rule.
- Added: `property-unit-denylist` rule.
- Added: `property-unit-allowlist` rule.
...
- Added: single value options to `*-denylist` & `-*allowlist` rules e.g. `{ "function-denylist": "calc"}`
...
- Fixed: the `property-denylist` rule message is now consistent with the `property-allowlist` rule.
...
- Added: `property-denylist` rule.
- Added: `property-no-vendor-prefix` rule.
- Added: `property-allowlist` rule.
